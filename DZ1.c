...
void vivod(long double *digits,long double *digits2,long double *digits2_1, int size, int flag){
...
void perevod(long double *digits,long double *digits2,long double *digits2_1, int size)
{
    for(int i = 0; i < size; i++){
        if (digits[i] >= 0){
...
int main (void)
{
    ...
    perevod(digits,digits2,digits2_1, size);

    vivod(digits,digits2,digits2_1, size, flag);
